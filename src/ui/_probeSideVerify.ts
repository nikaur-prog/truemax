...
export function headFrame(p: SidePoints): HeadFrame | null {
...
export function alongU(f: HeadFrame, x: number, y: number): number {
...
export function placeBackPoints(points: SidePoints, f: HeadFrame, headW: number): void {
...
export function frontAgreement(points: SidePoints, g: SideMaskGeometry, canvasW: number): number {
  let n = 0;
  let on = 0;
...
export function onMaskFraction(points: SidePoints, g: SideMaskGeometry, canvasW: number): number {
