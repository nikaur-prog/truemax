...
export const TEMPLATE: Record<SidePointId, [number, number]> = {
  ...
  menton: [-0.265, 0.984],
  gonion: [-0.914, 0.806],
  // Initial surface estimate near the ear, not a detected bony joint or a
  // required offset from tragion. Reviewers may separate these freely. Keep
  // the existing seed until paired annotations justify a fitted replacement;
  // do not fit a population template to one guide photograph.
